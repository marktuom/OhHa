...
public class NappulaTest {
    ...
    public void TestLiiku() {
        ...
        assertEquals(false, n1.liiku(r1));
    }
    ...
    @Test
    public void TestKasvataSiirtoja() {
        assertEquals(0, n1.getSiirtoja());
        n1.KasvataSiirtoja();
        assertEquals(1, n1.getSiirtoja());
    }
    
    @Test 
    public void TestAsetaRuutuun(){
        n1.asetaRuutuun(r1, l1.getRuutu(6, 5));
        assertEquals(n1, l1.getRuutu(6, 5).getNappula());
